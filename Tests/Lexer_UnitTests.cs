...
namespace Tests
{
    public class Lexer_UnitTests
    {
        ...
        {
            _tokenizerMock.TryParseDelimiter(Arg.Is("1"), out Arg.Any<string>()).Returns(false);
            _tokenizerMock.TryParseDelimiter(Arg.Is("1,"), out Arg.Any<string>()).Returns(arg => { arg[1] = ","; return true; });
            ...
            _tokenizerMock.Received(2).TryParseDelimiter(Arg.Is("1,"), out Arg.Any<string>());
            _tokenizerMock.Received(3).TryParseDelimiter(Arg.Is("1"), out Arg.Any<string>());
            _tokenizerMock.DidNotReceive().TryParseDelimiter(Arg.Is((string s) => s.Length > 2 || !s.StartsWith("1")), out Arg.Any<string>());
        ...
        public void Should_Throw_NagativeNumberException_When_Negative_Number_Given()
        {
            _tokenizerMock.TryParseDelimiter(Arg.Is("1"), out Arg.Any<string>()).Returns(false);
            _tokenizerMock.TryParseDelimiter(Arg.Is("1,"), out Arg.Any<string>()).Returns(arg => { arg[1] = ","; return true; });
            _tokenizerMock.TryParseDelimiter(Arg.Is("-"), out Arg.Any<string>()).Returns(false);
            _tokenizerMock.TryParseDelimiter(Arg.Is("-1"), out Arg.Any<string>()).Returns(false);
            _tokenizerMock.TryParseDelimiter(Arg.Is("-1,"), out Arg.Any<string>()).Returns(arg => { arg[1] = ","; return true; });
            _tokenizerMock.Identify(Arg.Is("1")).Returns(new Token(TokenType.Number, "1", 1));
            _tokenizerMock.Identify(Arg.Is(",")).Returns(new Token(TokenType.PlusOperator, ","));
            ...
            _tokenizerMock.Received(1).TryParseDelimiter(Arg.Is("1,"), out Arg.Any<string>());
            _tokenizerMock.Received(1).TryParseDelimiter(Arg.Is("-1,"), out Arg.Any<string>());
        ...
        public void Should_Throw_NullArgumentException_When_Null_Source_Given()
        {
            ...
            _tokenizerMock.DidNotReceiveWithAnyArgs().TryParseDelimiter(Arg.Any<string>(), out Arg.Any<string>());
        ...
        public void Should_Return_IgnoredNumber_Token_When_Empty_Source_Given()
        {
            ...
            _tokenizerMock.Received(0).TryParseDelimiter(Arg.Is(""), out Arg.Any<string>());
